...
{{-- Jewellery & Watche Types --}}
<div class="form-group input-ad_field">
	<label for="ad_field" class="col-sm-3 control-label">Jewellery &amp; Watche Types <i class="red">*</i></label>
	<div class="form-input col-sm-6 col-lg-3">
		<select id="ad_field" name="ad_field" class="form-control " required="">
			...
			<option value="rings" data-value="rings" class="empty1">Rings</option>
			<option value="necklaces-penants" data-value="necklaces-penants" class="empty1">Necklaces &amp; Penants</option>
			<option value="earrings" data-value="earrings" class="empty1">Earrings</option>
			<option value="jewelry-sets" data-value="jewelry-sets" class="empty1">Jewelry Sets</option>
			<option value="jewelry-accessories" data-value="jewelry-accessories" class="empty1">Jewelry Accessories</option>
			<option value="kid-watches" data-value="kid-watches" class="empty1">Kid's Watches</option>
			<option value="men-watches" data-value="men-watches" class="empty1">Men's Watches</option>
			<option value="women-watches" data-value="women-watches" class="empty1">Women's Watches</option>
