...
<div class="form-group input-ad_field">
	<label for="ad_field" class="col-sm-3 control-label">Cloths Type <i class="red">*</i></label>
	<div class="form-input col-sm-6 col-lg-3">
		<select id="ad_field" name="ad_field" class="form-control " required="">
			...
			<option value="kid-clothing" data-value="kid-clothing" class="empty1">Kid's Clothing</option>
			<option value="men-accessories" data-value="men-accessories" class="empty1">Men's Accessories</option>
			<option value="men-clothing" data-value="men-clothing" class="empty1">Men's Clothing</option>
			<option value="men-wallets" data-value="men-wallets" class="empty1">Men's Wallets</option>
			<option value="men-shoes" data-value="men-shoes" class="empty1">Men's Shoes</option>
			<option value="women-accessories" data-value="women-accessories" class="empty1">Women's Accessories</option>
			<option value="women-cothing" data-value="women-cothing" class="empty1">Women's Cothing</option>
			<option value="women-handbags" data-value="women-handbags" class="empty1">Women's Handbags</option>
			<option value="women-shoes" data-value="women-shoes" class="empty1">Women's Shoes</option>
			<option value="sunglasses" data-value="sunglasses" class="empty1">Sunglasses</option>
