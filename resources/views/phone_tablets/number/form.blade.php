...
<div class="form-group input-ad_condition">
	<label for="ad_condition" class="col-sm-3 control-label">Mobile Company <i class="red">*</i></label>
	<div class="form-input col-sm-6 col-lg-3">
		<select id="ad_condition" name="ad_condition" class="form-control " required="">
			...
			<option value="Mobitel" data-value="Mobitel" class="empty1">Mobitel</option>
			<option value="Metfone" data-value="Metfone" class="empty1">Metfone</option>
			<option value="Smart" data-value="Smart" class="empty1">Smart</option>
			<option value="Qube" data-value="Qube" class="empty1">Qube</option>
