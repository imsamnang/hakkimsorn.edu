			...
			<div class="my-container">
				<div class="lists-categories">
					<ul class="list-unstyled sub_categories">
						@foreach ($property_by_categories as $category)
							...
							<div class="filter_title">Refine your Results</div>
								<form class="form" id="ftr_left" method="get" action="{{route('property.allProperties')}}">
									...
									<div class="form-group filter-group ">
										...
										<div class="form-row">
											<div class="filter-data col">
												<input type="text" name="from_ad_year" value="" class="form-control form-control-" placeholder="From">
											</div>
											<div class="filter-data col">
												<input type="text" name="to_ad_year" value="" class="form-control form-control-" placeholder="To">
											</div>
											<div class="filter-data col-3">
												<button class="btn btn-default btn-"><span class="icon icon-next"></span></button>
											</div>
						...
						<div>
							<ul class="list-unstyled list-items item-list">
								@foreach ($property_by_categories as $category)
									...
									<a class="border post" href="#" title="{{$property->title}}">
									<article>
