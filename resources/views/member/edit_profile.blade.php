			...
			<div class="bg-white">
				<div class="content row">
							...
							<section>
								...
								<div class="list-items">
									<ul class="list-unstyled mb-0">
										<li class="active"><a href="https://www.khmer24.com/en/member/edit-profile">Edit Profile</a></li>
					...
					<div class="right-content col">
						...
						<input type="hidden" value="https://www.tinhtoday.com/" id="base_url">
						<input type="hidden" value="https://www.tinhtoday.com/template/" id="template_path">
